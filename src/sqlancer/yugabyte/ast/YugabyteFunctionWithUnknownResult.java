...
public enum YugabyteFunctionWithUnknownResult {
    ...
    // https://www.Yugabyteql.org/docs/devel/functions-admin.html#FUNCTIONS-ADMIN-SIGNAL-TABLE
    ...
    // https://www.Yugabyteql.org/docs/devel/functions-info.html#FUNCTIONS-INFO-SESSION-TABLE
    ...
    PG_JIT_AVAILABLE("pg_jit_available", YugabyteDataType.BOOLEAN),
    ...
    CONVERT_FROM("convert_from", YugabyteDataType.TEXT, YugabyteDataType.TEXT, YugabyteDataType.TEXT) {
        ...
        public YugabyteExpression[] getArguments(YugabyteDataType returnType, YugabyteExpressionGenerator gen,
                                                 int depth) {
            YugabyteExpression[] args = super.getArguments(returnType, gen, depth);
            args[1] = YugabyteConstant.createTextConstant(Randomly.fromOptions("UTF8", "LATIN1"));
            return args;
        }
    },
    // concat
    ...
    REGEX_REPLACE("regex_replace", YugabyteDataType.TEXT, YugabyteDataType.TEXT, YugabyteDataType.TEXT),
    ...
    // https://www.Yugabyteql.org/docs/9.5/functions-math.html
    ...
    // https://www.Yugabyteql.org/docs/12/functions-math.html#FUNCTIONS-MATH-TRIG-TABLE
    ...
    // https://www.Yugabyteql.org/docs/12/functions-math.html#FUNCTIONS-MATH-HYP-TABLE
    ...
    // https://www.Yugabyteql.org/docs/devel/functions-binarystring.html
    ...
    // range functions
    // https://www.Yugabyteql.org/docs/devel/functions-range.html#RANGE-FUNCTIONS-TABLE
    ...
    // https://www.Yugabyteql.org/docs/devel/functions-admin.html#FUNCTIONS-ADMIN-DBSIZE
    ...
    private YugabyteDataType returnType;
    private YugabyteDataType[] argTypes;
