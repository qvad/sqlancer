    ...
    public SQLQueryAdapter generate() {
        ...
        for (Action a : action) {
            ...
            case ALTER_COLUMN_TYPE:
                ...
                sb.append(" TYPE ");
                YugabyteDataType randomType = YugabyteDataType.getRandomType();
                YugabyteCommon.appendDataType(randomType, sb, false, generateOnlyKnown, opClasses);
            ...
            case ALTER_COLUMN_SET_DROP_DEFAULT:
                ...
                if (Randomly.getBoolean()) {
                    ...
                    sb.append(YugabyteVisitor.asString(
                            YugabyteExpressionGenerator.generateExpression(globalState, randomColumn.getType())));
