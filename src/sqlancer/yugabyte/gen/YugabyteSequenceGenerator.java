...
public final class YugabyteSequenceGenerator {

    private YugabyteSequenceGenerator() {
    }

    public static SQLQueryAdapter createSequence(YugabyteGlobalState globalState) {
