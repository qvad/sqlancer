...
public final class YugabyteSetGenerator {
    ...
    private enum ConfigurationOption {
        // https://www.Yugabyteql.org/docs/11/runtime-config-wal.html
        ...
        // archive_command
        // archive_timeout
        // https://www.Yugabyteql.org/docs/11/runtime-config-statistics.html
        ...
        // https://www.Yugabyteql.org/docs/11/runtime-config-autovacuum.html
        ...
        // https://www.Yugabyteql.org/docs/devel/runtime-config-query.html
        ...
        // https://www.Yugabyteql.org/docs/current/runtime-config-query.html#RUNTIME-CONFIG-QUERY-CONSTANTS
        ...
        // https://www.Yugabyteql.org/docs/current/runtime-config-query.html#RUNTIME-CONFIG-QUERY-GEQO
        ...
        // https://www.Yugabyteql.org/docs/current/runtime-config-query.html#RUNTIME-CONFIG-QUERY-OTHER
